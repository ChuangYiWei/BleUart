...
//    String defaultBleAddr = curBleAddr;
                ...
                if (_ST_SUCCESS_ == ((MainActivity) mcontext).uart_tx_command(writeSubStrCmd[0])) {
                    ...
                    for (i = 1; i < writeSubStrCmd.length; i++) {
                        ...
                        if (_ST_SUCCESS_ != ((MainActivity) mcontext).uart_tx_command(writeSubStrCmd[i])) {
                            commonutil.wErrLog("tx fail,cmd:" + writeSubStrCmd[i]);
                            return false;
                        }
                    }
                ...
                if (_ST_SUCCESS_ == ((MainActivity) mcontext).uart_tx_command(writeSubStrCmd[0])) {
                    ...
                    if (rev.length != 0) {
                        ...
                        if (!checkRevLen(rev, TESTMODE)) {
                            //work around, try three times if rev length not correct
                            if (retryNum < retryMax) {
                                commonutil.wdbgLog("retry cmd" + Integer.toString(retryNum));
                                retryNum++;
                                continue;
                            } else {
                                String errEvtStr = ((MainActivity) mcontext).bytes2String(rev);
    ...
    public void AIR_BD_IntvWrite()
    {
        Current_TEST_NAME = BD_TEST_INTV_WRITE;
        getTestlist(Current_TEST_NAME);
        commonutil.wdbgLogcat(TAG,0,"S AIR========================" + Current_TEST_NAME);

        while(AutoTestList.size() > 0 && ((MainActivity) mcontext).isThreadRunning()) {

            BDAutoTest testitem = AutoTestList.poll();

            if (!test_air_advIntvwrite(testitem)) {
                ((MainActivity) mcontext).writeLog2View(Current_TEST_NAME + " test fail");
                commonutil.wdbgLogcat(TAG, 2, Current_TEST_NAME + " test fail");
                ((MainActivity) mcontext).updateFailCnt();
            } else {
        ...
        commonutil.wdbgLogcat(TAG,0,"E AIR========================" + Current_TEST_NAME);
    }

    public boolean test_air_advIntvwrite(BDAutoTest testitem)
    {
    ...
    public void AIR_BD_AddrWrite()
    {
        ...
        while(AutoTestList.size() > 0 && ((MainActivity) mcontext).isThreadRunning()) {
            ...
            if (!test_air_addrwrite(testitem)) {
                ((MainActivity) mcontext).writeLog2View(Current_TEST_NAME + " test fail");
                commonutil.wdbgLogcat(TAG, 2, Current_TEST_NAME + " test fail");
                ((MainActivity) mcontext).updateFailCnt();
            } else {
    ...
    public boolean test_air_addrwrite(BDAutoTest testitem)
    {
        commonutil.wdbgLogcat(TAG,0,"*****" + testitem.gettestName() + ",data is " + testitem.getdataStr());
        setDefaultBleData();
        //set ble name from config
    ...
    public void AIR_BD_NameWriteCmd()
    {
        Current_TEST_NAME = BD_TEST_NAME_WRITE;
        getTestlist(Current_TEST_NAME);
        commonutil.wdbgLogcat(TAG,0,"S AIR========================" + Current_TEST_NAME);
        ...
        while(AutoTestList.size() > 0 && ((MainActivity) mcontext).isThreadRunning()) {
            ...
            if (!test_air_namewrite(testitem)) {
                ((MainActivity) mcontext).writeLog2View(Current_TEST_NAME + " test fail");
                commonutil.wdbgLogcat(TAG, 2, Current_TEST_NAME + " test fail");
                ((MainActivity) mcontext).updateFailCnt();
            } else {
    ...
    public boolean test_air_namewrite(BDAutoTest testitem)
    {
        commonutil.wdbgLogcat(TAG,0,"*****" + testitem.gettestName() + ",data is " + testitem.getdataStr());
    ...
    public void AIR_BD_AdvDataWrite() {
        Current_TEST_NAME = BD_TEST_ADVDATA_WRITE;
        ...
        if (advWriteTestOnlyOnce == 0) {
            while (AutoTestList.size() > 0 && ((MainActivity) mcontext).isThreadRunning()) {
                ...
                if (!test_air_advdatawrite(testitem)) {
                    ((MainActivity) mcontext).writeLog2View(Current_TEST_NAME + " test fail");
                    commonutil.wdbgLogcat(TAG, 2, Current_TEST_NAME + " test fail");
                    ((MainActivity) mcontext).updateFailCnt();
                } else {
        ...
        if (advWriteTestOnlyOnce == 1) {
            commonutil.wdbgLogcat(TAG, 0, "PASS AIR========================" + Current_TEST_NAME);

        }
    }

    public boolean test_air_advdatawrite(BDAutoTest testitem)
    {
        commonutil.wdbgLogcat(TAG,0,"*****" + testitem.gettestName() + ",data is " + testitem.getdataStr());
    ...
    public void AIR_BD_TxPowerWrite()
    {
        Current_TEST_NAME = BD_TEST_TXPOWER_WRITE;
        ...
        while(AutoTestList.size() > 0 && ((MainActivity) mcontext).isThreadRunning()) {
            ...
            if(!test_air_txpowerwrite(testitem)){
                ((MainActivity) mcontext).writeLog2View(Current_TEST_NAME + " test fail");
                commonutil.wErrLog(Current_TEST_NAME + " test fail");
                Log.e(TAG, Current_TEST_NAME + " test fail");
                ((MainActivity)mcontext).updateFailCnt();
    ...
    public boolean test_air_txpowerwrite(BDAutoTest testitem)
    {
        commonutil.wdbgLogcat(TAG,0,"*****" + testitem.gettestName() + ",data is " + testitem.getdataStr());
    ...
    public void AIR_BD_BatteryLevelWrite()
    {
        Current_TEST_NAME = BD_TEST_BATTERYLEVEL_WRITE;
        ...
        while(AutoTestList.size() > 0 && ((MainActivity) mcontext).isThreadRunning()) {
            ...
            BDAutoTest testitem = AutoTestList.poll();
            if(!test_air_BatteryWrite(testitem)){
                ((MainActivity) mcontext).writeLog2View(Current_TEST_NAME + " test fail");
                commonutil.wdbgLogcat(TAG, 2, Current_TEST_NAME + " test fail");
                ((MainActivity)mcontext).updateFailCnt();
            }
    ...
    public boolean test_air_BatteryWrite(BDAutoTest testitem)
    {
        String BatteryData = testitem.getdataStr();
        commonutil.wdbgLogcat(TAG,0,"*****" + testitem.gettestName() + ",data is " + BatteryData);
        ...
        //=====================connection======================
            ...
            while (testitem.cmdSize() > 0) {
                ...
                if (BatteryData.equals(revCharReadStr)) {
                    ...
                    ((MainActivity) mcontext).writeLog2View("fail evt ,revEvt:" + revCharReadStr);
                    commonutil.wdbgLogcat(TAG, 2, "fail evt ,revEvt:" + revCharReadStr);
                    return false;
                }
    ...
    public void AIR_BD_IntvLatencyWrite()
    {
        Current_TEST_NAME = BD_TEST_INTVLATENCY_WRITE;
        ...
        while(AutoTestList.size() > 0 && ((MainActivity) mcontext).isThreadRunning()) {
            ...
            BDAutoTest testitem = AutoTestList.poll();
            if(!test_air_IntvLantencywrite(testitem)){
                ((MainActivity) mcontext).writeLog2View(Current_TEST_NAME + " test fail");
                commonutil.wdbgLogcat(TAG, 2, Current_TEST_NAME + " test fail");
                ((MainActivity)mcontext).updateFailCnt();
            }
    ...
    public boolean test_air_IntvLantencywrite(BDAutoTest testitem)
    {
    ...
    public void AIR_BD_AdvDataWrite2() {
        Current_TEST_NAME = BD_TEST_ADVDATA2_WRITE;
        ...
        commonutil.wdbgLogcat(TAG, 0, "S AIR========================" + Current_TEST_NAME);
            while (AutoTestList.size() > 0 && ((MainActivity) mcontext).isThreadRunning()) {
                ...
                if (!test_air_advdata2write(testitem)) {
                    ((MainActivity) mcontext).writeLog2View(Current_TEST_NAME + " test fail");
                    commonutil.wdbgLogcat(TAG, 2, Current_TEST_NAME + " test fail");
                    ((MainActivity) mcontext).updateFailCnt();
                } else {
    ...
    public boolean test_air_advdata2write(BDAutoTest testitem)
    {
        String advdata2 = testitem.getdataStr();
        commonutil.wdbgLogcat(TAG,0,"*****" + testitem.gettestName() + ",data is " + advdata2);
    ...
    public void AIR_BD_ScanResDataWrite() {
        Current_TEST_NAME = BD_TEST_SCANRESDATA_WRITE;
    ...
    public void AIR_BD_DisconnectWrite() {
        Current_TEST_NAME = BD_TEST_DISCONN_WRITE;
        ...
        while (AutoTestList.size() > 0 && ((MainActivity) mcontext).isThreadRunning()) {
            ...
            if (!test_air_disconnectwrite(testitem)) {
                ((MainActivity) mcontext).writeLog2View(Current_TEST_NAME + " test fail");
                commonutil.wdbgLogcat(TAG, 2, Current_TEST_NAME + " test fail");
                ((MainActivity) mcontext).updateFailCnt();
            } else {
    ...
    public boolean test_air_disconnectwrite(BDAutoTest testitem)
    {
        ...
        if (commonutil.config.BLE) {
            ...
            if (!bleServiceInstance.isConnected()) {
                commonutil.wdbgLogcat(TAG, 0, "disconnect is right behavior !");
            } else {
                commonutil.wdbgLogcat(TAG, 2, "still connect is not right behavior here!");
            }
    ...
    public void AIR_BD_DataPayloadWrite() {
        Current_TEST_NAME = BD_TEST_DATA_PAYLOAD_WRITE;
        ...
        while (AutoTestList.size() > 0 && ((MainActivity) mcontext).isThreadRunning()) {
            ...
            if (!test_air_datapayload(testitem)) {
                ((MainActivity) mcontext).writeLog2View(Current_TEST_NAME + " test fail");
                commonutil.wdbgLogcat(TAG, 2, Current_TEST_NAME + " test fail");
                ((MainActivity) mcontext).updateFailCnt();
            } else {
    ...
    public boolean test_air_datapayload(BDAutoTest testitem)
    {
        String payloadData = testitem.getdataStr();
        commonutil.wdbgLogcat(TAG,0,"*****" + testitem.gettestName() + ",data is " + payloadData);
    ...
    public boolean test_air_phy(BDAutoTest testitem)
    {
        commonutil.wdbgLogcat(TAG,0,"*****" + testitem.gettestName() + ",data is " + testitem.getdataStr());
